...
class Buku_controller extends Controller
{
    public function index()
    {
        ...
        return view('admin.buku.buku_index', compact('title','kategoris'));
    }
    ...
    {
        $title = 'Edit Buku | Sangcahaya.com';
        $buku_id = $buku_id;
        $buku = Buku::where('buku_id',$buku_id)->first();
        $kategoris = Kategori::orderBy('nama', 'asc')->get();

        return view('admin.buku.buku_edit', compact('title','buku_id','buku','kategoris'));
    }
    ...
    public function yajra(Request $request)
    {
        ...
        $datatables = Datatables::of($buku)->addColumn('action', function ($buku) {
            return '<a href="'.url('admin/buku/edit/'.$buku->buku_id).'" buku-id="'.$buku->buku_id.'" judul="'.$buku->judul.'" class="btn btn-xs btn-primary"><i class="glyphicon glyphicon-edit"></i> Edit</a>'.

            '<a href="#hapus-'.$buku->buku_id.'" buku-id="'.$buku->buku_id.'" class="btn btn-xs btn-danger btn-hapus"><i class="glyphicon glyphicon-trash"></i> Hapus</a>';
